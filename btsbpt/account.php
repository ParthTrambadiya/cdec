...
<head>
    ...
    <title>Admin Account - CDEC</title>
                                    ...
                                    <table>
                                        <tr>
                                            <td class="text-center" width="30%">
                                                <img src="assets/images/avatars/<?php echo $row['img'];?>" class="profile_img" id="profile_img">
                                                <form id="profile_Form" enctype="multipart/form-data">
                                                    <input id="imageUpload" type="file" name="file" accept="image/*">
                                                    <button id="changeImg" class="btn btn-success" type="submit">Upload Image</button>
                                                    <p class="img_p_upload">Image Uploaded</p>
                                                </form>
                                            </td>
                                            <td>
                                                <table class="table table-borderless">
                                                    <form id="login_form" class="admin_form">
                                                    <tr>
                                                        <td>FULLNAME</td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <input type="text" class="form-control" name="fullname" value="<?php echo $row['fullname'];?>" id="fullname" required>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>EMAIL</td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <input type="text" class="form-control" name="email" value="<?php echo $row['email'];?>" id="email" required>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>PASSWORD</td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <button type="submit" id="submit_form" class="btn btn-success">Save Changes</button>
                                                        </td>
                                                    </tr>
                                                    </form>
                                                </table>
...
<script type="text/javascript" src="./assets/scripts/validateAcc.js"></script></body>
