...
if (!defined('PDF_HEADER_LOGO')) {
	$tcpdf_header_logo = '';
	if (@file_exists('abinayagymlogo.png')) {
		$tcpdf_header_logo = 'abinayagymlogo.png';
	}
...
if (!defined('PDF_CREATOR')) {
	define ('PDF_CREATOR', 'Abinaya Gym HR');
}

if (!defined('PDF_AUTHOR')) {
	define ('PDF_AUTHOR', 'Abinaya Gym HR');
}

if (!defined('PDF_HEADER_TITLE')) {
	define ('PDF_HEADER_TITLE', 'Abinaya GYM');
}

if (!defined('PDF_HEADER_STRING')) {
	define ('PDF_HEADER_STRING', "by Abinaya Gym Administration");
}
