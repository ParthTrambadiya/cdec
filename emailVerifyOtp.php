...
if(isset($_GET['action'])) {
   ...
   ';
        ...
        try {
            ...
            $mail->addAddress($_SESSION['emailNew']);
            ...
            if($mail->send()){
                ...
                $query = 'select * from users where email="'.$_SESSION['emailNew'].'"';
                ...
                if($total_row > 0)
                {
                    $_SESSION['user_new_otp'] = $user_otp;
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12 text-justify">
                                ...
                                <h6 class="font-baloo px-5">Your email is not verified. You have to verify your email first. We have sent an OTP on your following email <span class="color-blue"><?php echo $_SESSION['emailNew'];?></span>. Please enter that OTP below.</h6>
                            </div>
                            <div class="col-12">
                                <form method="post" id="Verify" class="px-5" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>">
                                    <div class="row form-group font-baloo mt-5">
                                        <div class="col-12 mb-3 mb-md-0">
                                            ...
                                            <div class="text-right">
                                                <label><a href="emailVerifyOtp.php?action=resend" name="resend" class="font-baloo color-blue btn">Resend OTP</a></label>
                                            </div>
                                        </div>
                                    </div>
